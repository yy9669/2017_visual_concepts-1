...
val_file_name='/data2/haow3/data/imagenet/dataset/val_no_crop_'+occlusion_level+'.txt'
train_filenames, train_labels = list_images(train_dir)
val_filenames, val_labels = list_images_from_txt(val_file_name)

train_dir2='/data2/xuyangf/OcclusionProject/NaiveVersion/ApertureImage/train/top10vc'
...
with tf.Session(graph=graph,config=config) as sess:
	...
	for epoch in range(num_epochs):
	    ...
	    #break
	saver.save(sess, os.path.join(finetunedir, 'aperture_top10vc'))
